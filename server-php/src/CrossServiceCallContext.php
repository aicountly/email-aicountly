...
final class CrossServiceCallContext
{
    ...
    private const KNOWN = [
        'manage', 'contacts', 'calendar', 'drive', 'books', 'inventory', 'sales',
        'purchases', 'billing', 'pos', 'pay', 'connect', 'lobby', 'appointments',
        'crm', 'helpdesk', 'notes', 'contracts', 'hrms', 'auditor', 'fr',
        'secretarial', 'vault', 'voice', 'email',
    ];
    ...
    /** CLI only: reset between test cases. */
