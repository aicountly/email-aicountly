 ...
 *
 * It reaches exactly one schema: the tables Email owns — mailbox configuration,
 * memberships, labels, drafts, scheduled sends, message references, AI outputs,
 * action records and audit. It is never pointed at Books, Inventory, Manage,
 * Calendar or Contacts, and there is no second connection that could be: those
 * are read and written through their HTTP APIs (see src/Clients and
 * src/Integrations). A cross-database join is not a shortcut here, it is the
 * architecture failing — two products would hold two answers to the same
 * question and something would have to reconcile them.
 */
final class Db
{
