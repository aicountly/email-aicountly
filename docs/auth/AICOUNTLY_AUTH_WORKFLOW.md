...
1. User opens `email.aicountly.com` (or `email.gh.aicountly.com`).
...
| Email host | Login redirect | Auth API | Product API |
|---|---|---|---|
| `email.aicountly.com` | `my.aicountly.com` | `my.aicountly.com` | `email.aicountly.com/api` |
| `email.gh.aicountly.com` | `sandbox.aicountly.com` | `my.aicountly.com` | `email.gh.aicountly.com/api` |
...
`email` out of either hostname, and `isSandboxHost()` picks the portal.
